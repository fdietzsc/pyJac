...
void dydt (const double t, const double pres, const double * __restrict__ y, double * __restrict__ dy) {
  ...
  dy[0] = (-1.0 / (rho * cp_avg)) * ((dy[1] * h[0] * 1.0079400000000001e+00)
        ...
        + (dy[8] * h[7] * 3.1998799999999999e+01) + (dy[9] * h[8] * 3.3006740000000001e+01)
        + (dy[10] * h[9] * 3.4014679999999998e+01));
  ...
  dy[6] *= (2.8010399999999997e+01 / rho);
  dy[7] *= (2.9018339999999998e+01 / rho);
  dy[8] *= (3.1998799999999999e+01 / rho);
  dy[9] *= (3.3006740000000001e+01 / rho);
  dy[10] *= (3.4014679999999998e+01 / rho);
  dy[11] *= (4.4009799999999998e+01 / rho);
  dy[12] *= (4.0026000000000002e+00 / rho);
...
void dydt (const double t, const double rho, const double * __restrict__ y, double * __restrict__ dy) {
  ...
  dy[0] = (-1.0 / (rho * cv_avg)) * ((dy[1] * u[0] * 1.0079400000000001e+00)
        ...
        + (dy[8] * u[7] * 3.1998799999999999e+01) + (dy[9] * u[8] * 3.3006740000000001e+01)
        + (dy[10] * u[9] * 3.4014679999999998e+01));
