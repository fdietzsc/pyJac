...
void get_rxn_pres_mod (const double T, const double pres, const double * __restrict__ C, double * __restrict__ pres_mod) {
  ...
  // reaction 4;
  pres_mod[0] = m + 1.5 * C[1] + 11.0 * C[4] + 0.9 * C[5] + 2.8 * C[10] - 1.0 * C[11];

  // reaction 6;
  pres_mod[1] = m + 1.5 * C[1] + 11.0 * C[4] - 1.0 * C[11] + 0.9 * C[5] + 2.8 * C[10];

  // reaction 8;
  pres_mod[2] = m + 1.5 * C[1] + 11.0 * C[4] - 0.25 * C[11] + 0.9 * C[5] + 2.8 * C[10];

  // reaction 9;
  pres_mod[3] = m + 1.5 * C[1] + 11.0 * C[4] - 0.62 * C[11] + 0.9 * C[5] + 2.8 * C[10];

  // reaction 10;
  thd = m + 2.0 * C[1] + 15.0 * C[4] + 0.1 * C[7] + 1.7 * C[5] + 4.4 * C[10] + 0.2 * C[11];
  k0 = exp(3.2135486597795008e+01 - 1.5 * logT - (2.4768466982367991e+02 / T));
  ...
  // reaction 17;
  thd = m + 1.5 * C[1] + 11.0 * C[4] + 0.9 * C[5] + 2.8 * C[10] - 0.36 * C[11];
