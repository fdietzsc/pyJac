...
void eval_spec_rates (const double * __restrict__ fwd_rates, const double * __restrict__ rev_rates, const double * __restrict__ pres_mod, double * __restrict__ sp_rates, double * __restrict__ dy_N) {
  ...
  //sp 7
  sp_rates[7] += (fwd_rates[6] - rev_rates[6]) * pres_mod[1];

  //rxn 7
  //sp 2
  sp_rates[2] -= 2.0 * (fwd_rates[7] - rev_rates[7]);
  //sp 7
  sp_rates[7] += (fwd_rates[7] - rev_rates[7]);

  //rxn 8
  //sp 0
  sp_rates[0] -= (fwd_rates[8] - rev_rates[8]) * pres_mod[2];
  //sp 2
  ...
  //rxn 9
  //sp 0
  sp_rates[0] -= (fwd_rates[9] - rev_rates[9]) * pres_mod[3];
  //sp 3
  ...
  //rxn 10
  //sp 0
  sp_rates[0] -= (fwd_rates[10] - rev_rates[10]) * pres_mod[4];
  //sp 8
  sp_rates[8] = (fwd_rates[10] - rev_rates[10]) * pres_mod[4];
  //sp 7
  sp_rates[7] -= (fwd_rates[10] - rev_rates[10]) * pres_mod[4];
  ...
  //sp 3
  sp_rates[3] += 2.0 * (fwd_rates[12] - rev_rates[12]);
  ...
  //rxn 15
  //sp 8
  sp_rates[8] -= 2.0 * (fwd_rates[15] - rev_rates[15]);
  //sp 9
  ...
  //rxn 16
  //sp 8
  sp_rates[8] -= 2.0 * (fwd_rates[16] - rev_rates[16]);
  //sp 9
  ...
  //rxn 17
  //sp 9
  sp_rates[9] -= (fwd_rates[17] - rev_rates[17]) * pres_mod[5];
  //sp 3
  sp_rates[3] += 2.0 * (fwd_rates[17] - rev_rates[17]) * pres_mod[5];
